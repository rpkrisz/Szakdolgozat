...
const LoadSubject: FC<{
  ...
  return (
    <div className="flex flex-col w-full justify-start text-white gap-4 bg-secondary text-secondary-content rounded-md p-2 lg:col-span-2">
      <h3 className="font-bold text-lg">Load subject tasks</h3>
      <div className="flex flex-col 2xl:flex-row justify-around gap-1">
        <SelectInput
          label="University"
          name="universityID"
